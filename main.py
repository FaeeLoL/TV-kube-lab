...
producer_config = make_config(os.environ.get("HOST", "10.90.138.176"), "MYW", "guest", "guest")
consumer_config = make_config(os.environ.get("HOST", "10.90.138.176"), "MyQ", "guest", "guest")
